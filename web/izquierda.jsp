        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a class="waves-effect waves-light" href="index.html"><i class="fa fa-home"></i> TABLERO</a></li>
                    <li><a class="waves-effect waves-light"><i class="fa fa-desktop"></i>Registrar Horarios <span
                                class="fa fa-chevron-right"></span></a>
                        <ul class="nav child_menu">
                            <li> <a class="waves-effect waves-light" href="insert.jsp">Insertar</a></li>
                    ...
                    <li><a class="waves-effect waves-light"><i class="fa fa-cube"></i>Ver Horarios <span
                                class="fa fa-chevron-right"></span></a>
                        <ul class="nav child_menu">
                            <li> <a class="waves-effect waves-light" href="listHorario.jsp">Horario</a></li>
